...
diab_continuous_data <- select(diabetes_data, -c(Outcome, DiabetesPedigreeFunction)) # continuous variable(s). Excluded initially.
...
pca <- prcomp(t(diab_cont_matrix), scale = TRUE)
